...
- Frontend: `React` (pasta `frontendJogo`)
...
- O `docker-compose.yml` usa `frontendJogo` como contexto de build do frontend.
- Em modo local (fora do Docker), execute em `frontendJogo/`:
  - `npm install`
  - `npm run dev`
